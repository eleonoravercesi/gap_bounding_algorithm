...
/**
 * Get all the ancestors with n + k edges. Require
 * @param k integer
 */
...
int main(int argc, char *argv[]) {
        ...
        if (argc > 1) { // Else, I will use your value
            k = std::atoi(argv[1]);
        }
